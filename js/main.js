...
LoadingState.preload = function () {
    ...
    this.game.load.spritesheet('spider', 'images/spider.png', 48.28, 40);
    this.game.load.spritesheet('door', 'images/door.png', 60, 60);
    this.game.load.spritesheet('icon:key', 'images/key_icon.png', 30, 38);

    this.game.load.audio('sfx:jump', 'audio/jump.wav');
    this.game.load.audio('sfx:coin', 'audio/coin.wav');
    this.game.load.audio('sfx:key', 'audio/key.wav');
    this.game.load.audio('sfx:stomp', 'audio/stomp.wav');
    this.game.load.audio('sfx:door', 'audio/porta.ogg');
